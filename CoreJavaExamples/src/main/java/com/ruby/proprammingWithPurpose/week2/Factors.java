package com.ruby.proprammingWithPurpose.week2;


import com.ruby.stream.StringStreamOperations;
...
public class Factors {
    ...
    public static void main(String[] args) {
        ...
        for (long n: new Factors().testData()) {
            ...
            Duration interval = Duration.between(end , start);
            System.out.printf("elapsed time %d s %n " , interval.getSeconds());
        }
    ...
    public long[] testData(){
        long[] data = new long[]{997, 999983, 999999937, 999999999989l, 999999999999989l, 999999999999999989l};
        return data;
    }
}
